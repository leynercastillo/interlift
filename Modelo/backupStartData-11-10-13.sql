...
-- Started on 2013-10-11 09:41:21
...
--
-- TOC entry 1967 (class 0 OID 37691)
-- Dependencies: 153
...
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (83, 'BUDGET', '40 X 50 (STANDARD)', 'DOOR FRAME TYPE', false, 1, NULL, 'A', NULL);
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (144, 'BUDGET', 'FORMICA - VERTICAL CON ESQUINERO EN ACERO INOX. RECTO', 'DESIGN', false, 3, NULL, 'A', NULL);
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (145, 'BUDGET', 'FORMICA - VERTICAL CON ESQUINERO EN ACERO INOX. REDONDO', 'DESIGN', false, 4, NULL, 'A', NULL);
...
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (112, 'BUDGET', 'ACERO INOX. 304-4 VERTICAL CON ESQUINERO EN ACERO INOX.', 'DESIGN', false, 6, NULL, 'A', NULL);
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (125, 'BUDGET', 'ACERO INOX. ESPEJO - HORIZONTAL CON ESQUINERO EN ACERO INOX.', 'DESIGN', false, 7, NULL, 'A', NULL);
INSERT INTO basic_data (id_basic, data_base_name, name, field, editable, priority, imageurl, status, parent_id_basic) VALUES (137, 'BUDGET', 'OTRO', 'DESIGN', false, 8, NULL, 'A', NULL);
...
--
-- TOC entry 1972 (class 0 OID 37715)
-- Dependencies: 158
...
--
-- TOC entry 1962 (class 0 OID 37667)
-- Dependencies: 148
...
--
-- TOC entry 1975 (class 0 OID 37725)
-- Dependencies: 161
...
--
-- TOC entry 1964 (class 0 OID 37675)
-- Dependencies: 150
...
--
-- TOC entry 1959 (class 0 OID 37654)
-- Dependencies: 145
...
--
-- TOC entry 1965 (class 0 OID 37684)
-- Dependencies: 151
...
--
-- TOC entry 1969 (class 0 OID 37702)
-- Dependencies: 155
...
--
-- TOC entry 1970 (class 0 OID 37708)
-- Dependencies: 156
...
--
-- TOC entry 1977 (class 0 OID 37737)
-- Dependencies: 163
...
--
-- TOC entry 1978 (class 0 OID 37746)
-- Dependencies: 164
...
--
-- TOC entry 1957 (class 0 OID 37646)
-- Dependencies: 143
...
--
-- TOC entry 1960 (class 0 OID 37660)
-- Dependencies: 146
...
-- Completed on 2013-10-11 09:41:22
