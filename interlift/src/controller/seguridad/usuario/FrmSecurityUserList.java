...
public class FrmSecurityUserList {
	...
	public void save(@BindingParam("user") SecurityUserStatus user) {
		edit(user);
		/*
		 * Al modificar un objeto persistente en la base de datos, este primero debe almacenarse en una variable
		 * local, para que hibernate no detecte dos sesiones abiertas.
		 */
